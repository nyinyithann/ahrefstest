...
function ErrorBoundary$Fallback(Props) {
  ...
  return React.createElement("div", {
              className: styles.main
                ...
                }, React.createElement("header", undefined, React.createElement("h2", undefined, "Sorry, something went wrong!")), React.createElement("nav", undefined, React.createElement("p", undefined, "Would you try to reload the whole site?"), React.createElement("button", {
                          type: "button",
                          onClick: onClick
                        }, "Reload")), React.createElement("details", undefined, React.createElement("summary", undefined, "Details"), tmp, React.createElement("p", undefined, "" + info.componentStack + ""))));
}
