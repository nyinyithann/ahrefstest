...
function CountrySelect(Props) {
  ...
  var value = match$1[0];
  var match$2 = CountriesProvider.useCountriesContext(undefined);
  var loadCountries = match$2.loadCountries;
  React.useEffect((function () {
          debugger;
          var controller = new AbortController();
          Curry._1(loadCountries, controller.signal);
